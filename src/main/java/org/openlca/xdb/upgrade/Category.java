...
class Category {
	...
	public static void map(IDatabase oldDb, IDatabase newDb, Sequence index)
		...
		Mapper<Category> mapper = new Mapper<>(Category.class, oldDb, newDb);
	...
	private static class Handler extends UpdateHandler<Category> {
		...
		public String getStatement() {
			return "INSERT INTO tbl_categories(id, ref_id, name, "
